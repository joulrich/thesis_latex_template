...
Als Erstes wird mit einem \glqq async_resolve\grqq{} sowie der URL und dem Port die IP-Adresse des Servers ermittelt.
...
Diese Nachrichten sind entweder Anfragen nach beispielsweise Statusinformationen, Standortdaten und Streams oder Heartbeats.
